import{r as x,a as L,i as k,b as a}from"./shared-B4XGjr1g.js";/* empty css             */const $="https://raw.githubusercontent.com/Cindy94502/cindy-data/main/posts.json",E=new URLSearchParams(location.search),S=E.get("id"),C={買房筆記:"cat-teal",南崁生活:"cat-sage","Q&A":"cat-yellow",物件介紹:"cat-peach"};document.getElementById("app").innerHTML=`
  ${x()}
